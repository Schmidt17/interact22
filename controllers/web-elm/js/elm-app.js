...
var $author$project$Main$attrMax = $elm$html$Html$Attributes$max;
var $elm$html$Html$Attributes$min = $elm$html$Html$Attributes$stringProperty('min');
var $author$project$Main$attrMin = $elm$html$Html$Attributes$min;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('label-container')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('labels')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Last MQTT message: ' + model.mqttMessage)
									])),
								A2(
								$elm$html$Html$div,
								_List_Nil,
