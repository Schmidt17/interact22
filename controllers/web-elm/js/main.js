...
var $author$project$Main$SingleSliderChange = function (a) {
	return {$: 'SingleSliderChange', a: a};
};
	...
	var model = {
		...
		singleSlider: A2(
			...
			$carwow$elm_slider$SingleSlider$init(
				{max: 127, min: 0, onChange: $author$project$Main$SingleSliderChange, step: 1, value: 50}))
	};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'SingleSliderChange') {
			var newVal = msg.a;
			var newSlider = A2($carwow$elm_slider$SingleSlider$update, newVal, model.singleSlider);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$carwow$elm_slider$SingleSlider$view(model.singleSlider)
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
